...
namespace NerdDinner.Models
{
    ...
    public class NerdDinners : DbContext, INerdDinners
    {
        ...
        public NerdDinners()
        {
            ...
            //this.Database.Connection.ConnectionString = @"data source=DIXON13J\SQLEXPRESS;Integrated Security=SSPI;Initial Catalog=NerdDinner;MultipleActiveResultSets=True";
        }
